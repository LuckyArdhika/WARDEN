...
const DrawerHeader = styled('div')<{justifyContent?: string}>(({ theme, justifyContent }) => ({
  display: 'flex',
  alignItems: 'center',
    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <AppBar position="fixed" open={open}>
        <Toolbar>
          ...
          <Box sx={{ flexGrow: 0, marginRight: "12px", marginLeft: "auto" }}>
      ...
      <Drawer variant="permanent" open={open}>
        <div className="d-flex">
          <DrawerHeader justifyContent="center" style={{width: '100%'}}>
            {process.env.NEXT_PUBLIC_APP_NAME}
          </DrawerHeader>
          <DrawerHeader justifyContent="flex-end" style={{width: 'fit-content'}}>
